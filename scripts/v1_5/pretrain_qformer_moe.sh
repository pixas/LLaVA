...
#SBATCH --output=logs/llava7b_qformer-pretrain-5e4-256q.out
...
srun --jobid $SLURM_JOBID python -u -m torch.distributed.run \
    ...
    --bf16 True \
    --output_dir /remote-home/syjiang/checkpoints/llava-v1.5-7b-pretrain-qformer-5e4_256q \
    --num_train_epochs 1 \
